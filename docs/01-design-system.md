...
- Style: X5 / Пятёрочка executive strategy deck
- Avoid generic PowerPoint and generic AI deck aesthetics
- Creativity is allowed only as an extension of existing Figma patterns
